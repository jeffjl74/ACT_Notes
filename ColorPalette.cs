...
//
// JJL 2022 - Added some more palette selections
//            Use extended ColorDialog that allows setting its position
	...
	public class ColorPalette : ScrollableControl
	{
		...
		protected void SetDefaultPalette()
		{
			...
			switch (DefaultPalette)
			{
				...
				case Palette.Saturated:
					ColorItems.Add(Color.Black);
					ColorItems.Add(Color.Sienna);
					ColorItems.Add(Color.Red);
					ColorItems.Add(Color.OrangeRed);
					ColorItems.Add(Color.Orange);
					ColorItems.Add(Color.Yellow);
					ColorItems.Add(Color.LimeGreen);
					ColorItems.Add(Color.Green);
					ColorItems.Add(Color.Aquamarine);
					ColorItems.Add(Color.Cyan);
					ColorItems.Add(Color.SkyBlue);
					ColorItems.Add(Color.Blue);
					ColorItems.Add(Color.MediumVioletRed);
					ColorItems.Add(Color.Magenta);
					ColorItems.Add(Color.Pink);
					ColorItems.Add(Color.White);
					break;
		...
		{
			// Create color dialog
			ColorDialog dlg = new ColorDialogEx(this.Parent.Left, this.Parent.Top);
